      ...
      <View style={[styles.container]}>
        ...
        <View style={styles.details}>
          <View style={styles.detail}>
            <AppText style={styles.title}>
              Swap Aero Contractors Ticket ID: EF12H63
            </AppText>
          </View>
        ...
        <View style={styles.section}>
          <ButtonPrimary
            ...
            title="Swap with New One"
          />
        </View>
      </View>
      <NewTicketModal
        onDone={() => navigate(NAVIGATION_ROUTES.FLIGHT_DETAILS)}
      />
    </AppScreen>
  );
};

export default SwapTicketsDetails;
